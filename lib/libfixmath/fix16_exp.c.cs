...
//using uint_fast8_t = System.UInt32;
using uint_fast8_t = System.Int32;
...
namespace libfixmath
{
    internal static partial class LibFixMath
    {
...
#if !FIXMATH_NO_CACHE
        static fix16_t[] _fix16_exp_cache_index = new fix16_t[4096];
        static fix16_t[] _fix16_exp_cache_value = new fix16_t[4096];
#endif

        public static fix16_t fix16_exp(fix16_t inValue)
        {
            if (inValue == 0)
                return fix16_one;
        ...
        public static fix16_t fix16_log(fix16_t inValue)
        {
        ...
        public static fix16_t fix16_rs(fix16_t x)
        {
         ...
         */
        public static fix16_t fix16__log2_inner(fix16_t x)
        {
            fix16_t result = 0;
         ...
         */
        public static fix16_t fix16_log2(fix16_t x)
        {
         ...
         */
        public static fix16_t fix16_slog2(fix16_t x)
        {
