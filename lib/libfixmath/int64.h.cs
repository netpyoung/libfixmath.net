...
[MethodImpl(MethodImplOptions.AggressiveInlining)] public static __int64_t int64_const(int32_t hi, uint32_t lo) { return (__int64_t){ hi, lo }; }
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static __int64_t int64_from_int32(int32_t x) { return (__int64_t){ (x < 0 ? -1 : 0), x }; }
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static int32_t int64_hi(__int64_t x) { return x.hi; }
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static uint32_t int64_lo(__int64_t x) { return x.lo; }

    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static bool int64_cmp_eq(__int64_t x, __int64_t y) { return ((x.hi == y.hi) && (x.lo == y.lo)); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static bool int64_cmp_ne(__int64_t x, __int64_t y) { return ((x.hi != y.hi) || (x.lo != y.lo)); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static bool int64_cmp_gt(__int64_t x, __int64_t y) { return ((x.hi > y.hi) || ((x.hi == y.hi) && (x.lo > y.lo))); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static bool int64_cmp_ge(__int64_t x, __int64_t y) { return ((x.hi > y.hi) || ((x.hi == y.hi) && (x.lo >= y.lo))); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static bool int64_cmp_lt(__int64_t x, __int64_t y) { return ((x.hi < y.hi) || ((x.hi == y.hi) && (x.lo < y.lo))); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static bool int64_cmp_le(__int64_t x, __int64_t y) { return ((x.hi < y.hi) || ((x.hi == y.hi) && (x.lo <= y.lo))); }

    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static __int64_t int64_add(__int64_t x, __int64_t y)
    {
        __int64_t ret;
        ret.hi = x.hi + y.hi;
        ret.lo = x.lo + y.lo;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static __int64_t int64_neg(__int64_t x)
    {
        __int64_t ret;
        ret.hi = ~x.hi;
        ret.lo = ~x.lo + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static __int64_t int64_sub(__int64_t x, __int64_t y)
    {
        return int64_add(x, int64_neg(y));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static __int64_t int64_shift(__int64_t x, int8_t y)
    {
        __int64_t ret;
        if (y > 0)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static __int64_t int64_mul_i32_i32(int32_t x, int32_t y)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static __int64_t int64_mul_i64_i32(__int64_t x, int32_t y)
    {
        int neg = ((x.hi ^ y) < 0);
        if (x.hi < 0)
            x = int64_neg(x);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static __int64_t int64_div_i64_i32(__int64_t x, int32_t y)
    {
        int neg = ((x.hi ^ y) < 0);
        if (x.hi < 0)
            x = int64_neg(x);
