...
namespace libfixmath
{
    ...
    {
        public const fix16_t FOUR_DIV_PI = 0x145F3;            /*!< Fix16 value of 4/PI */
        public const fix16_t _FOUR_DIV_PI2 = unchecked((fix16_t)0xFFFF9840);        /*!< Fix16 value of -4/PI² */
        public const fix16_t X4_CORRECTION_COMPONENT = 0x399A;  /*!< Fix16 value of 0.225 */
        public const fix16_t PI_DIV_4 = 0x0000C90F;             /*!< Fix16 value of PI/4 */
        public const fix16_t THREE_PI_DIV_4 = 0x00025B2F;       /*!< Fix16 value of 3PI/4 */

        public const fix16_t fix16_maximum = 0x7FFFFFFF; /*!< the maximum value of fix16_t */
        public const fix16_t fix16_minimum = unchecked((fix16_t)0x80000000); /*!< the minimum value of fix16_t */
        public const fix16_t fix16_overflow = unchecked((fix16_t)0x80000000); /*!< the value used to indicate overflows when FIXMATH_NO_OVERFLOW is not specified */

        public const fix16_t fix16_pi = 205887;     /*!< fix16_t value of pi */
        public const fix16_t fix16_e = 178145;     /*!< fix16_t value of e */
        public const fix16_t fix16_one = 0x00010000; /*!< fix16_t value of 1 */

        /* Conversion functions between fix16_t and float/integer.
         * These are inlined to allow compiler to optimize away constant numbers
         */
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fix16_t fix16_from_int(int a) { return a * fix16_one; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float fix16_to_float(fix16_t a) { return (float)a / fix16_one; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double fix16_to_dbl(fix16_t a) { return (double)a / fix16_one; }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int fix16_to_int(fix16_t a)
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fix16_t fix16_from_float(float a)
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fix16_t fix16_from_dbl(double a)
    {
        ...
        */
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fix16_t F16(float x)
        {
            return ((fix16_t)(((x) >= 0) ? ((x) * 65536.0 + 0.5) : ((x) * 65536.0 - 0.5)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fix16_t fix16_abs(fix16_t x)
        { return (x < 0 ? -x : x); }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fix16_t fix16_floor(fix16_t x)
        { return (fix16_t)((ulong)x & 0xFFFF0000UL); }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fix16_t fix16_ceil(fix16_t x)
        { return (fix16_t)((ulong)x & 0xFFFF0000UL) + ((((ulong)x & 0x0000FFFFUL) != 0) ? fix16_one : 0); }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fix16_t fix16_min(fix16_t x, fix16_t y)
        { return (x < y ? x : y); }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fix16_t fix16_max(fix16_t x, fix16_t y)
        { return (x > y ? x : y); }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
// extern fix16_t fix16_atan2(fix16_t inY, fix16_t inX) FIXMATH_FUNC_ATTRS;
    ...
    public const fix16_t fix16_rad_to_deg_mult = 3754936;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix16_t fix16_rad_to_deg(fix16_t radians)
    { return fix16_mul(radians, fix16_rad_to_deg_mult); }

    public const fix16_t fix16_deg_to_rad_mult = 1144;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix16_t fix16_deg_to_rad(fix16_t degrees)
    { return fix16_mul(degrees, fix16_deg_to_rad_mult); }
        ...
        */
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix16_t fix16_sq(fix16_t x)
